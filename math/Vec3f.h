...
class Vec3f
{
    public:
        ...
        Vec3f(value_type const * const p) {_v[0] = p[0]; _v[1] = p[1]; _v[2] = p[2];}
        ...
        */
        ...
        inline Vec3f componentMultiply(const Vec3f& rhs);
...
inline Vec3f Vec3f::componentMultiply(const Vec3f& rhs)
{
    return Vec3f(_v[0]*rhs[0], _v[1]*rhs[1], _v[2]*rhs[2]);
}
