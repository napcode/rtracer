...
class Vec4f
{
    public:
        ...
        Vec4f(value_type const * const p) {_v[0] = p[0]; _v[1] = p[1]; _v[2] = p[2]; _v[3] = p[3];}
...
inline Vec4f Vec4f::componentMultiply(const Vec4f& rhs)
{
    return Vec4f(_v[0]*rhs[0], _v[1]*rhs[1], _v[2]*rhs[2], _v[3]*rhs[3]);
}
