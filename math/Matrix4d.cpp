...
Matrix4d::Matrix4d( value_type a00, value_type a01, value_type a02, value_type a03,
...
void Matrix4d::set( value_type a00, value_type a01, value_type a02, value_type a03,
                  value_type a10, value_type a11, value_type a12, value_type a13,
                  value_type a20, value_type a21, value_type a22, value_type a23,
                  value_type a30, value_type a31, value_type a32, value_type a33)
{
...
void Matrix4d::preMult( const Matrix4d& other )
{
...
void Matrix4d::postMult( const Matrix4d& other )
{
    // brute force method requiring a copy
...
{
    const Matrix4d::value_type* lhs = reinterpret_cast<const Matrix4d::value_type*>(_mat);
    const Matrix4d::value_type* end_lhs = lhs+16;
    const Matrix4d::value_type* rhs = reinterpret_cast<const Matrix4d::value_type*>(m._mat);
...
void Matrix4d::setTrans( value_type tx, value_type ty, value_type tz )
{
    _mat[3][0] = tx;
    _mat[3][1] = ty;
    _mat[3][2] = tz;
}
void Matrix4d::setTrans( const Vec3f& v )
{
    _mat[3][0] = v[0];
    _mat[3][1] = v[1];
    _mat[3][2] = v[2];
}
void Matrix4d::setTrans( const Vec3d& v )
{
    _mat[3][0] = v[0];
    _mat[3][1] = v[1];
    _mat[3][2] = v[2];
...
#define QZ  q._v[2]
#define QW  q._v[3]
void Matrix4d::setRotate(const Quat& q)
{
...
void Matrix4d::makeRotate( const Vec3f& from, const Vec3f& to )
{
    makeIdentity();
...
void Matrix4d::makeRotate( const Vec3d& from, const Vec3d& to )
{
    makeIdentity();
...
void Matrix4d::makeRotate( value_type angle, const Vec3f& axis )
{
    makeIdentity();
...
void Matrix4d::makeRotate( value_type angle, const Vec3d& axis )
{
    makeIdentity();
...
void Matrix4d::makeRotate( value_type angle, value_type x, value_type y, value_type z ) 
{
    makeIdentity();
...
void Matrix4d::makeRotate( const Quat& quat )
{
    makeIdentity();
...
void Matrix4d::makeRotate( value_type angle1, const Vec3f& axis1, 
...
void Matrix4d::makeRotate( value_type angle1, const Vec3d& axis1, 
